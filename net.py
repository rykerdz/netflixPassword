...
first_string = input("Enter the email and the password: ")
my_list = first_string.split(":")

new_password = "test123" # put your password here
...
def main():
    ...
    print("#\n#\n#\nsuccessfully changed the password of ' " + my_list[0] + " ' to : "+ new_password+"\n\n")
    sleep(5)
